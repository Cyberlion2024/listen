...
import Faster100xDisplay from "./Faster100xDisplay";
...
export const ToolMessage = ({
  ...
  if (toolOutput.name === "FASTER100X_ANALYSIS") {
    try {
      const faster100xData = JSON.parse(toolOutput.result);
      return (
        <div className="mb-1">
          <Faster100xDisplay data={faster100xData} />
        </div>
      );
    } catch (e) {
